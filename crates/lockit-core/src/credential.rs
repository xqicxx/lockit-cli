...
impl CredentialType {
    /// Parse a credential type string, accepting both snake_case (CLI) and PascalCase (Android).
    pub fn from_flexible(s: &str) -> Self {
        match s {
            "api_key" | "ApiKey" => Self::ApiKey,
            "git_hub" | "GitHub" => Self::GitHub,
            "account" | "Account" => Self::Account,
            "coding_plan" | "CodingPlan" => Self::CodingPlan,
            "password" | "Password" => Self::Password,
            "phone" | "Phone" => Self::Phone,
            "bank_card" | "BankCard" => Self::BankCard,
            "email" | "Email" => Self::Email,
            "token" | "Token" => Self::Token,
            "ssh_key" | "SshKey" => Self::SshKey,
            "webhook_secret" | "WebhookSecret" => Self::WebhookSecret,
            "o_auth_client" | "OAuthClient" => Self::OAuthClient,
            "aws_credential" | "AwsCredential" => Self::AwsCredential,
            "gpg_key" | "GpgKey" => Self::GpgKey,
            "database_url" | "DatabaseUrl" => Self::DatabaseUrl,
            "id_card" | "IdCard" => Self::IdCard,
            "note" | "Note" => Self::Note,
            _ => Self::Custom,
        }
    }
...
impl CredentialType {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Self::GitHub => {
                "Store GitHub credentials for private repos, CI/CD, and agent git operations"
            }
...
pub fn find_field_insensitive<'a>(
